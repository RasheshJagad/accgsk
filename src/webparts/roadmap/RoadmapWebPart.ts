  ...
  public render(): void {
    const element: React.ReactElement<IRoadmapProps> = React.createElement(
      Roadmap,
      {
        ...
        roadmapTitle: this.properties.roadmapTitle,
        roadmapDescription: this.properties.roadmapDescription
      }
    );
          ...
          groups: [
            {
              groupName: "",
              groupFields: [
                // PropertyPaneTextField('roadmapTitle', {
                //   label: "Roadmap Title"
                // }),
                // PropertyPaneTextField('roadmapDescription', {
